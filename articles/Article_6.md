...
1. Technical Sales: The Transmitter Archetype
...
· Naming the problem in the buyer’s language first (not yours)
· Mapping your solution to their existing mental models
· Showing how each feature maps to a specific business or personal value
...
2. Non‑Sales Professionals: The Visionary Without Infrastructure
...
· A written summary that captures the key points (so they don’t have to remember)
· A clear next step that doesn’t require them to commit fully
· Language they can use to sell the idea internally
...
3. AI‑Enabled Sales: The Human Bottleneck
...
· Rapidly assess the buyer’s current structure
· Identify the gaps between their structure and the solution
· Articulate the connection in a way that the buyer can rebuild

AI gives you time back. Use it to think more precisely.

4. The Transfer Layer: Preventing Post‑Meeting Dissolution
...
· A one‑page summary that answers the likely internal objections
· A stakeholder map showing who needs to buy in and why
· Language they can use that aligns with their organisation’s existing values
...
· Scripts and closing techniques
· Persuasion and enthusiasm
· Personality‑based approaches

You need:

· A framework for encoding the four layers of intent
· Tools for diagnosing the buyer’s existing structure
· Methods for building scaffolding that supports decision‑making
· A clear transfer layer that prevents post‑meeting dissolution
